...
<template>
  <div class="w-full relative mt-2">
    <button
      ...
      class="h-3 rounded-full border flex items-center justify-center flex-shrink-0 relative border-transparent hover:border-white hover:bg-white text-slate-600 hover:bg-white hover:shadow dark:text-slate-100 dark:hover:border-gray-600 dark:hover:bg-gray-600 transition transform hover:scale-100 font-bold"
      :class="
        creating
          ? 'dark:border-gray-600 dark:bg-gray-600 bg-white border-white shadow scale-100'
